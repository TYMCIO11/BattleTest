  ...
  ("multiplayer_item_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_presentation_obj_item_select_18", -1),
      (assign, "$g_presentation_obj_item_select_19", -1),
      (assign, "$g_presentation_obj_item_select_20", -1),
      (assign, "$g_presentation_obj_item_select_21", -1),
      (assign, "$g_presentation_obj_item_select_22", -1),
      #INVASION MODE START
      (assign, "$g_presentation_obj_item_select_117", -1),
      #INVASION MODE END
      (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (create_in_game_button_overlay, "$g_presentation_obj_item_select_117", "str_mp_add_troop"),
          (overlay_set_color, "$g_presentation_obj_item_select_117", 0xFFFFFF),
          (position_set_x, pos1, 500),
          (position_set_y, pos1, 650),
          (overlay_set_position, "$g_presentation_obj_item_select_117", pos1),
        ...
        (try_begin),
          ...
          (try_for_range, ":ai_troop_no", multiplayer_ai_troops_begin, multiplayer_ai_troops_end),
            ...
            (store_add, ":special_cur_y", ":cur_y", 8),
            (position_set_y, pos1, ":special_cur_y"),
            (overlay_set_position, reg0, pos1),
            (try_begin),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          #INVASION MODE START
          (else_try),#Berk
            (eq, ":object", "$g_presentation_obj_item_select_117"),
            (assign, "$g_presentation_state", 10),
            (presentation_set_duration, 0),
            (start_presentation, "prsnt_multiplayer_item_select"),
          #INVASION MODE END
